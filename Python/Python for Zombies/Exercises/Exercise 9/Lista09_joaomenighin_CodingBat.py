...
# C. common_end
# Dada duas listas a e b verifica se os dois primeiros sÃ£o
# iguais ou os dois Ãºltimos sÃ£o iguais
...
# D. maior_ponta
# Dada uma lista nÃ£o vazia, cria uma nova lista onde todos
# os elementos sÃ£o o maior das duas pontas
# obs.: nÃ£o Ã© o maior de todos, mas entre as duas pontas
# maior_ponta([1, 2, 3]) -> [3, 3, 3]
# maior_ponta([1, 3, 2]) -> [2, 2, 2]
def maior_ponta(nums):
    maior = nums[0] if nums[0] > nums[-1] else nums[-1]
    res = []
    for i in nums:
        res.append(maior)
    return res
...
def squirrel_play(temp, is_summer):
  return temp >= 60 and ((temp <= 90 and not is_summer) or (temp <= 100 and is_summer))
...
# J. alarm_clock
# day: 0=domingo, 1=segunda, 2=terÃ§a, ..., 6=sÃ¡bado
# vacation = True caso vocÃª esteja de fÃ©rias
# o retorno Ã© uma string que diz quando o despertador tocarÃ¡
# dias da semana '07:00'
# finais de semana '10:00'
# a menos que vocÃª esteja de fÃ©rias, neste caso:
